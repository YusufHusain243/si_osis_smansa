...
<head>
    ...
    <title>Siswa | OSIS SMAN 1 Pandih Batu</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script>
        selectImageEdit.onchange = evt => {
            preview_edit = document.getElementById('preview-edit');
            preview_edit.style.display = 'block';
            const [file_edit] = selectImageEdit.files
            if (file_edit) {
                preview_edit.src = URL.createObjectURL(file_edit)
            }
        }
    </script>
